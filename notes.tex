...
Use direct proof with the contrapositive form
\begin{align*}
    \sim Q \implies \sim P
\end{align*}
...
\textbf{Proposition:} $P \Leftrightarrow Q$.
...
\textbf{Proposition:} $\exists x, P(x)$.

Show that the statement is true by using some value of $x$ as an example.

\subsection*{Non-constructive proofs}
TODO: Take notes if this proves to be important.
